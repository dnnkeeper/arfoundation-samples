...
Shader "Standard Triplanar WorldUV Debug"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #pragma surface surf Standard vertex:vert novertexlights noforwardadd // fullforwardshadows addshadow
        ...
        void vert(inout appdata_full v, out Input data)
        {
			...
			//v.vertex.xyz;
            data.worldN = mul(unity_ObjectToWorld, v.normal.xyz);
        }

        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            // Blending factor of triplanar mapping
            float3 bf = normalize(abs(IN.worldN));
            bf /= dot(bf, (float3)1);
